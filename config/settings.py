...
AUTH_USER_MODEL = 'autenticacion.UsuarioCustom'
...
DATABASES = {
    'default': dj_database_url.config(
        ...
        conn_max_age=600,
        ssl_require= config('DATABASE_SSL_REQUIRE', cast=bool),
    )}
...
# Carpeta static global
STATICFILES_DIRS = [
    BASE_DIR / "static",
]

# Donde Django junta todo con collectstatic (para producción)
